import { getGmailClient } from './gmail-auth-lambda.js';
import { Buffer } from 'buffer';

// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// CREATE GMAIL DRAFT (Email Format Version) - Lambda S3 Version
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export async function createGmailDraft(meetingNotes, meetingTitle, meetingDate, meetingUrl = null) {
  try {
    ...
    console.log(`✅ Draft created successfully: ${res.data.id}`);
    return res.data;
  } catch (error) {
